...
export function TrickQuizScreen({ question, progress, onAnswer }: { question: Question, progress: number, onAnswer: (p: any, forceEnd?: boolean) => void }) {
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      if (Math.random() > 0.8) {
        ...
        glitchTimeoutRef.current = setTimeout(() => setGlitch(false), 150);
      }
    }, 400);
